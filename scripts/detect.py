...
print('Filtering using Jacardian')
...
pickling_on = open("./bible/potentialParseTrees.pickle","wb")
pickle.dump(potentialParseTrees, pickling_on)

pickling_on = open("./bible/potentialParsedSentences.pickle","wb")
...
pickling_on = open("./bible/allScores.pickle","wb")
...
pickling_on = open("./bible/scoreTuples.pickle","wb")
pickle.dump(scoreTuples, pickling_on)

f=open('./bible/outputScores-2.txt','a')
...
f=open('./bible/outputScores-filtered.txt','a') 
