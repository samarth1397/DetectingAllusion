...
def main():
	d=detect(inputFolder='../data/poe-5/',outputFolder='../output/poe-5/')
	...
	reducedBooks=d.filterWithJacard(textChunks,books,threshold=0.01)
	pickling_on = open('../output/'+'poe-5/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/orderedTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-5/diffTuples.pickle',"wb")
