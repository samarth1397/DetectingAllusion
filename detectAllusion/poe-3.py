...
def main():
	d=detect(inputFolder='../data/poe-3/',outputFolder='../output/poe-3-2/')
	...
	pickling_on = open('../output/'+'poe-3-2/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/orderedTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'poe-3-2/diffTuples.pickle',"wb")
