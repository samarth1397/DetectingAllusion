...
def main():
	...
	d=detectParagraph(inputFolder='../data/n1/',outputFolder='../output/n1-re/',cores=32)
	...
	pickling_on = open('../output/'+'n1-re/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-re/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-re/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-re/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-re/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-re/orderedTuples.pickle',"wb")
