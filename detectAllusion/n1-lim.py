...
def main():
	...
	d=detectParagraph(inputFolder='../data/n1-lim/',outputFolder='../output/n1-lim/',cores=32)
	...
	pickling_on = open('../output/'+'n1-lim/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-lim/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-lim/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-lim/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-lim/orderedTuples.pickle',"wb")
