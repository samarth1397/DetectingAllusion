...
def main():
	...
	d=detectParagraph(inputFolder='../data/n2/',outputFolder='../output/n2-re/',cores=32)
	...
	pickling_on = open('../output/'+'n2-re/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n2-re/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n2-re/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n2-re/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n2-re/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n2-re/orderedTuples.pickle',"wb")
