...
def main():
	...
	d=detectParagraph(inputFolder='../data/n3-lim/',outputFolder='../output/n3-lim/',cores=32)
	...
	reducedSpacyBooks,reducedSentences=d.filterWithJacard(spacyTextChunks,spacyBooksPara,threshold=0.09) #filtering on spacy data structure
	reducedBooks=d.filterOriginalBooks(reducedSentences,booksPara) #filtering on the original books

	pickling_on = open('../output/'+'n3-lim/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3-lim/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3-lim/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3-lim/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3-lim/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3-lim/orderedTuples.pickle',"wb")
