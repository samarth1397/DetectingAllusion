...
def main():
	...
	d=detectParagraph(inputFolder='../data/n5/',outputFolder='../output/n5/',cores=32)
	...
	pickling_on = open('../output/'+'n5/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n5/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n5/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n5/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n5/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n5/orderedTuples.pickle',"wb")
