...
def main():
	d=detect(inputFolder='../data/gutenberg-1/',outputFolder='../output/gutenberg-1/')
	...
	pickling_on = open('../output/'+'gutenberg-1/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/allScores.pickle',"wb")
	pickle.dump(syntacticScore, pickling_on)

	pickling_on = open('../output/'+'gutenberg-1/allScores2.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/orderedTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'gutenberg-1/diffTuples.pickle',"wb")
