...
def main():
	d=detect(inputFolder='../data/mark/',outputFolder='../output/mark/')
	...
	pickling_on = open('../output/'+'mark/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/orderedTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark/diffTuples.pickle',"wb")
