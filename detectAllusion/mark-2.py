...
def main():
	d=detect(inputFolder='../data/mark/',outputFolder='../output/mark-2/')
	...
	pickling_on = open('../output/'+'mark-2/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/orderedTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'mark-2/diffTuples.pickle',"wb")
