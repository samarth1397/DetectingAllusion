...
def main():
	...
	d=detectParagraph(inputFolder='../data/n1-latest/',outputFolder='../output/n1-latest/',cores=32,language='de')
	...
	pickling_on = open('../output/'+'n1-latest/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-latest/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-latest/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-latest/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-latest/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n1-latest/orderedTuples.pickle',"wb")
