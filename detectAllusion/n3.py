...
def main():
	...
	d=detectParagraph(inputFolder='../data/n3/',outputFolder='../output/n3/',cores=32)
	...
	pickling_on = open('../output/'+'n3/reducedBooks.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3/parseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3/potentialParseTrees.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3/allScores.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3/scoreTuples.pickle',"wb")
	...
	pickling_on = open('../output/'+'n3/orderedTuples.pickle',"wb")
